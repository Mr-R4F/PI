...
SELECT (MAX(IdProjeto)) + 1 , 1, 1, 'minhas produções', '12444365', '2001-04-01', 'olá 9856y8', 'N' FROM projeto
...
INSERT INTO projeto (IdProjeto, IdUsuario, IdCategoria, nome, url, dataPostagem, descricao, ativo) 
	SELECT ISNULL(MAX(IdProjeto),0) + 1 , 1, 1, 'minhas produções', '12444365', '2001-04-01', 'olá 9856y8', 'N' FROM projeto
...
VALUES (1, 4, 'minhas produções', '12444365', '2001-04-01', 'olá 9856y8', 'N') 
...
INSERT INTO projeto (IdAutor, IdCategoria, nome, url, dataPostagem, descricao, ativo) 
VALUES (3, 3, 'minhas produções', '12444365', '2001-04-01', 'olá 9856y8', 'N') 
