...
$condicoes = [strlen($pesquisa) ? "nomeCategoria LIKE '%".str_replace(' ', '%',$pesquisa)."%'" : null, "projeto_LL.ativo = 'S'"]; 
...
$stmt = $bd -> query(
    ...
    INNER JOIN usuario_LL ON usuario_LL.IdUsuario = projeto_LL.IdUsuario
    $where AND categoria_LL.nomeCategoria = '$categoria' ORDER BY imagens OFFSET 
