...
$stmt = $bd -> query(
    "SELECT projeto_LL.nomeProjeto, projeto_LL.dataPostagem, projeto_LL.imagens, projeto_LL.IdProjeto, projeto_LL.ativo
    FROM projeto_LL
    INNER JOIN usuario_LL ON usuario_LL.IdUsuario = proprojeto_LLjeto.IdUsuario
    WHERE usuario_LL.nomeUsuario = '$nomeUsuario'
");
$stmt -> execute();