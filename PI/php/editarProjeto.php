...
$nomeProjeto = htmlentities($_POST['nome']);
$data = $_POST['data'];
...
if (isset($_POST['ativo'])) 
    $_POST['ativo'] == "S" ? $ativo = 'S' : $ativo = 'N';

$stmt = $bd -> prepare(
    "UPDATE projeto SET nomeProjeto = :nomeProjeto, dataPostagem = '$data', ativo = '$ativo', imagens = '$arquivoEnviado', descricao = :descr
