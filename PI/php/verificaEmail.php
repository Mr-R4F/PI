    ...
    if (empty($user)) { #se encontrar email igual
        ?>
            ...
            <div class="modal-body text-center">
                <p class="fs-4 p-0">O email informado não foi encontrado</p>
            </div>
        <?php
    } else { #se o email existe
        ?> 
            ...
            <div class="modal-body text-center">
                <p class="fs-4 p-0">Email encontrado!</p>
            </div>
            <script>
                setTimeout(() => {
                    location.href = '/PI/paginas/recuperacaoSenha.php';
                }, 1200);
            </script>
        <?php
    }
