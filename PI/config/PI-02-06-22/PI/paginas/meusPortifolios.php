...
<html lang="pt-BR">
    <head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
            ...
            <link href="/PI/js-css/body.css" rel="stylesheet" type="text/css">
            ...
            <section class="container">
                ...
                <div class="row">
                    <div class="col-12 mx-auto">    
                        <div class="projeto card shadow-lg mt-5 mb-3">
                            <a href="/PI/paginas/configuracoesAdd.php" class="btn btn-outline-secondary col-2 mx-auto mb-3 mt-3" id="addNovo">Adicionar novo</a>
                            <div class="card-body">
                                <?php 
                                                    ...
                                                    <a href="../paginas/configuracoesER.php?id=<?php echo $val['IdProjeto']?>" class="link text-decoration-none text-muted">
                                                        <div class="card shadow d-flex flex-wrap justify-content-center justify-content-lg-start">
                                                            <div class="row align-items-center">
                                                                <div class="col-4">
                                                                    <img src="<?php echo $val['imagens']; ?>" width="100%" height="260px" class="card-img">
                                                                </div>
