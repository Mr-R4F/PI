                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="desc" id="descricao" class="form-control" cols="20" rows="5"></textarea>
                                                </div>
                                                <button type="submit" name="ok" class="btn btn-outline-secondary w-25 mt-5 mb-4">OK</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
