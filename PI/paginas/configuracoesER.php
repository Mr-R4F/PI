                    ...
                    <div class="row">     
                        <div class="col-10 mx-auto my-auto">
                            <div class="card text-center pt-4 pb-4">
                                <form action="../php/editarRemoverProjeto.php" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-5">
                                                <img src="" alt="" width="100%" height="500px" id="imgPrevia">
                                            </div>

                                            <div class="col-7">
                                                <label for="cod" class="form-label">Cod.:</label>
                                                <input type="number" class="form-control" id="cod" name="cod" value="<?php echo $_SESSION['val']; ?>" disabled>
                                                ...
                                                <input type="text" class="form-control" id="nome" name="nome" value="<?php echo $_SESSION['nomeProj']; ?>">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-check form-check-inline">
                                                                    <?php echo $_SESSION['inputSim']; ?>
                                                                    <label class="form-check-label" for="s">Sim</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <?php echo $_SESSION['inputNao']; ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="desc" id="descricao" class="form-control" cols="20" rows="5"><?php echo $_SESSION['descr']; ?></textarea>
                                                </div>
