                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control shadow-sm" id="nome" name="nome" value="<?php echo $val['nomeProjeto']; ?>" required autocomplete="off">
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="cod" class="form-label mt-4">Data</label>
                                                            <input type="date" class="form-control shadow-sm" id="data" name="data" required>
                                                        </div> 
                                                    </div>
                                                    <div class="col-6">
