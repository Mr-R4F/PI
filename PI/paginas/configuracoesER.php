    ...
    <body>
        <header class="header p-2 pb-1 col-lg-12 fixed-top">
            <nav class="navbar navbar-expand-md">
                <div class="container">
                    <a href="index.php" class="navbar-brand text-decoration-none text-white">
            ...
            <div class="offcanvas offcanvas-end d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item mt-1">
                        <a href="perfil.php" class="navegacao nav-link text-white">
            ...
            </div><!-- offcanvas  --><div class="offcanvas offcanvas-end d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 280px;" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
            ...
            <section class="container">
                    ...
                    <div class="row">
                        <div class="col-12 mx-auto my-auto">
                            <form action="../php/editarProjeto.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
                                <?php
                                ...
                                <div class="projeto card text-center shadow">
                                    <div class="row">
                                        <div class="col-6">
                                            <img src="<?php echo $val['imagens'] ?>" width="100%" height="100%" id="imgPrevia" class="card-img">
                                        </div>
                                        <div class="col-6">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <label for="cod" class="form-label">Cod.: Projeto</label>
                                                        <input type="number" class="form-control shadow-sm" id="cod" name="cod" value="<?php echo $_GET['id']; ?>" disabled>
                                                    </div>
                                                    <div class="col-4">
                                                        <label for="categoria" class="form-label">Categoria</label>
                                                        <select class="form-select shadow-sm" id="categoria" name="categoria" disabled>
                                                            <?php echo $img ?>
                                                            <?php echo $prot ?>
                                                            <?php echo $proj ?>
                                                        </select>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control shadow-sm" id="nome" name="nome" value="<?php echo $val['nomeProjeto']; ?>" autocomplete="off">
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="cod" class="form-label mt-4">Data</label>
                                                            <input type="date" class="form-control shadow-sm" id="data" name="data">
                                                        </div> 
                                                    </div>
                                                    <div class="col-6">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control shadow-sm" id="img" name="img" onchange="imgPreview(this)">
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                            <div class="form-group">
                                                            <label for="descricao" class="form-label mt-4">Descrição</label>  
                                                            <textarea name="descr" id="descricao" class="form-control shadow-sm" cols="20" rows="5"><?php echo $val['descricao']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>        
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <button type="submit" name="edita" class="btn btn-outline-secondary mt-5 mb-4" id="edita" data-id="<?php echo $_GET['id']; ?>" value="editar">Editar</button>
                                        <button type="submit" formaction="../php/deletarProjeto.php?id=<?php echo $_GET['id']; ?>" name="deletar" class="btn btn-outline-secondary ms-5 mt-5 mb-4" id="remove" data-id="<?php echo $_GET['id']; ?>">Excluir</button>
                                    </div> 
                                </div>
                            </form>   
                        </div>
                    ...
                    <div class="modal fade" id="modalER" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <footer class="bg-dark mt-5">
            ...
            <script src="/PI/js-css/modalER.js"></script>
    </body>
</html>