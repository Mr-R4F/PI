                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                                ...
                                                <input type="text" class="form-control" id="autor" name="autor" value="<?php echo $_SESSION['id']; ?>" disabled>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="ativo" id="s" value="S">
                                                                    <label class="form-check-label" for="s">Sim</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio" name="ativo" id="n" value="N">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="desc" id="descricao" class="form-control" cols="20" rows="5" placeholder=""></textarea>
                                                </div>
