...
<html lang="pt-BR">
    ...
    <body>
        <div class="container-fluid pt-5">
                ...
                <div class="col-3 mx-auto mt-5">
                    <form action="/PI/php/gravarUsuario.php" method="post">
                        <fieldset class="me-3 ms-3">
                            ...
                            <div class="form-floating">
                                <input type="email" class="form-control mt-4" name="email" id="Email" placeholder="Email" autocomplete="off" required>
                            ...
                            <button type="submit" class="btn btn-outline-secondary mt-5 mb-4 w-50">Cadastrar</button>
            ...
            <script src="/PI/Assets/script.js"></script>
    </body>
</html>