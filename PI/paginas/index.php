...
<!DOCTYPE html>
    ...
    <body>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12 shadow-lg d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mt-4 border-bottom border-top bg-light">
                        <form action="#" method="get" class="d-flex col-lg-auto mb-lg-0 flex-fill me-5">
                            <div class="input-group">
                        ...
                        <ul class="list-group list-group-horizontal col-12 col-md-auto mb-2 justify-content-center mb-md-0 ms-5 me-5">
                            <li class="list-group-item flex-fill">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton1">
                                        <li><a class="dropdown-item" href="?ordem=AZ">Nome (A-Z)</a></li>
                                        <li><a class="dropdown-item" href="?ordem=ZA">Nome (Z-A)</a></li>
                    ...
                    <div class="row mx-auto">
                        <?php 
                            if (isset($_GET['pesquisa'])) { #Se pesquisa estiver definida...
                                if ($totalLin['lin'] > 0) { #...e o resultado da linha for maior que 0 ...
                                        ...
                                        ?> 
                                            <div class="col-3 mt-5 mb-3 text-center">
                                                <a href="?id=<?php echo $val['IdProjeto']?>" class="link text-decoration-none" data-id="<?php echo $val['IdProjeto'] ?>">
                                                    <div class="card mb-3 overflow-hidden" style="border-radius: 15px;">
                                                        <img src="<?php echo $val['imagens']; ?>" height="350px" class="card-img bg-dark" style="border-radius: 15px;">
                                                    </div>
                                                </a> 
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="card shadow d-flex flex-row justify-content-around align-itens-center">
                                                            <p class="my-auto p-1"><?php echo ucfirst($val['nomeUsuario'])?></p> 
                                                            <p class="my-auto p-1"><?php echo ucfirst($val['nomeProjeto'])?></p> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                if(isset($_GET['pag'])) {
                                    while($val = $stmt -> fetch(PDO::FETCH_ASSOC)) { 
                                        ?> 
                                            <div class="col-3 mt-5 mb-3 text-center">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="card d-flex flex-row justify-content-around align-itens-center">
                                                            <p class="my-auto p-1"><?php echo ucfirst($val['nomeUsuario'])?></p> 
                                                            <p class="my-auto p-1"><?php echo ucfirst($val['nomeProjeto'])?></p> 
                                                        </div>
                                                    </div>
                                    ...
                                    while($val = $stmt -> fetch(PDO::FETCH_ASSOC)) { #while do ativo/ filtros
                                        ?> 
                                            <div class="col-3 mt-5 mb-3 text-center">
                                                <a href="?id=<?php echo $val['IdProjeto']?>" class="link text-decoration-none" data-id="<?php echo $val['IdProjeto'] ?>">
                                                    <div class="card shadow mb-3 overflow-hidden"  style="border-radius: 15px;">
                                                        <img src="<?php echo $val['imagens']; ?>" height="350px" class="card-img bg-dark" style="border-radius: 15px;">
                                                    </div>
                                                </a> 
                                                <div class="row">
                                ...
                                <ul class="pagination justify-content-center">
                                    <?php   
                                        ...
                                        for ($i = 1; $i < $numPag + 1; $i++) {
                                            ?> 
                                                <li class="page-item"><a class="page-link" href="<?php echo isset($_GET['ordem']) ? "?ordem={$_GET['ordem']}&pag={$i}" : (isset($_GET['categoria']) ? "?categoria={$_GET['categoria']}&pag={$i}" : "?pag={$i}")?>"><?php echo $i?></a></li>
                                            <?php
                                        }  
        ...
        <footer class="bg-dark mt-5">
            ...
            <script src="/PI/js-css/modalIndex.js"></script>
    </body>
</html>