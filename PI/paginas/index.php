            ...
            <div class="container-fluid">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mt-4 mb-4 border-bottom">
                    <ul class="list-group list-group-flush col-12 col-md-auto mb-2 justify-content-center mb-md-0">  
                        ...
                        <?php 
                            if (isset($_GET['submit'])) //filtro ordem
                ...
                <div class="row">
                    <?php 
                        while($val = $stmt -> fetch(PDO::FETCH_ASSOC)) { //while do ativo/ pesquisa /filtros
                            ?> 
                                <div class="col-3 mt-5 text-center teste">
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="card text-start">
                                                    <p class="ms-2"><?php echo $val['nomeUsuario']?></p> 
                                                    <p class="ms-2"><?php echo $val['nomeProjeto']?></p> 
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="card">
                        ...
                        ?><!-- corrigir -->
                        <!--p class="display-6 d-flex justify-content-center mb-3 mt-5">Nenhum projeto encontrado</p>
                            <ul class="ms-5" style="list-style-type: circle;">
                                <li>Verifique a gráfia</li>
                                <li>Certifique-se que todas as palavras estejam escritas corretamente</li>
                            </ul -->
                        <?php
                    ?>
