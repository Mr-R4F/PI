                                                            ...
                                                            <div class='card shadow-sm d-flex flex-wrap justify-content-center justify-content-lg-start'>
                                                                <div class='row align-items-center'>
                                                                    ...
                                                                    <div class='col-6 mx-auto'>
                                                                        <p class='card-text px-2'><?php echo $val['nomeProjeto']; ?></p>
                                                                        <p class='card-text px-2 pt-4'><?php echo $val['dataPostagem']; ?></p>
                                                                        <p class='card-text px-2 pt-4'><?php echo $val['IdProjeto'] ?></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
