                            ...
                            <form action="../php/editarRemoverProjeto.php?id=<?php echo $_GET['id']; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <button type="submit" name="edita" class="btn btn-outline-secondary mt-5 mb-4" id="edita">Editar</button>
                                        <button type="submit" name="deleta" class="btn btn-outline-secondary ms-5 mt-5 mb-4" id="remove">Excluir</button>
                                    </div> 
                                </div>
                            </form>   
                        </div>
